...
function DropdownMenuSubTrigger({
  ...
  return (
    <TextClassContext.Provider
      value={cn(
        textVariants({ variant: 'paragraphSmall' }),
        'select-none group-active:text-accent-foreground',
...
function DropdownMenuItem({
  ...
  return (
    <TextClassContext.Provider
      value={cn(
        textVariants({ variant: 'paragraphSmall' }),
        'select-none text-popover-foreground group-active:text-popover-foreground',
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <TextClassContext.Provider
      value={cn(
        textVariants({ variant: 'paragraphSmall' }),
        'text-popover-foreground select-none group-active:text-accent-foreground'
      )}>
  ...
  return (
    <DropdownMenuPrimitive.Label
      className={cn(
        ...
        'text-foreground px-2 py-2 sm:py-1.5',
        inset && 'pl-8',
        className
      )}
      {...props}
