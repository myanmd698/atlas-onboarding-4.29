...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      className={cn(textVariants({ variant: 'headingXSmall' }), 'leading-none text-foreground', className)}
      {...props}
    />
  );
}
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      className={cn(textVariants({ variant: 'paragraphSmall' }), 'text-muted-foreground', className)}
      {...props}
    />
  );
}
