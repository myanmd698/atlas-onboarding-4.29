  ...
  return (
    <SelectPrimitive.Value
      ...
      className={cn(
        ...
        'text-foreground line-clamp-1 flex flex-row items-center gap-2',
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      className={cn(
        textVariants({ variant: 'labelXSmall' }),
        'text-muted-foreground px-2 py-2 sm:py-1.5',
        className
      )}
      {...props}
    />
  ...
  return (
    <SelectPrimitive.Item
      ...
      <SelectPrimitive.ItemText
        className={cn(
          textVariants({ variant: 'paragraphSmall' }),
          'text-foreground group-active:text-accent-foreground select-none'
        )}
      />
    </SelectPrimitive.Item>
  );
